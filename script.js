...
/* =========================================
   SCORE OCR RESULT
   ให้จำนวนบรรทัดเป็นตัวหลัก
   รองลงมาคือจำนวนตัวอักษร
   และ confidence
========================================= */
...
async function runOCR(
  ...
  try {
    ...
    /* =====================================
       ...
       รอบนี้สำคัญกับภาพที่มี
       หลายบรรทัด / ไทย + อังกฤษ
    ===================================== */
...
console.log(
  "🌐 ผู้ช่วยแปลภาษา + General OCR Thai/English พร้อมใช้งาน"
);
